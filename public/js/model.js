function togglenew(service_id) {
    console.log(service_id);
    // Use fetch to call the Laravel route
    // fetch(`/packages/${package_name}/${service_id}`)
    ...
    //     console.log(response);
        ...
        //         option.textContent = package.package_name; // Set the text content of the option to the package name
        ...
        //                 var divContainer =
        //                     document.getElementById("packageOption");
        ...
        //                     var option = document.createElement("option"); // Create an <option> element
        //                     option.textContent = package.package_options; // Set the text content of the option to the package option
        //                     option.value = package.id; // Set the value of the option to the package id
        //                     select.appendChild(option); // Append the <option> element to the <select> element
        //                 });
